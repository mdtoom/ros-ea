...
if __name__ == '__main__':
    num_generations = 100
    num_runs = 5
    launch_file = 'sim_launch_one_world.launch'

    simulation_base_directory = expanduser("~") + '/Desktop/one_path/'
    ...
    config_location = 'configs/config-feedforward-2-hidden-layers'
